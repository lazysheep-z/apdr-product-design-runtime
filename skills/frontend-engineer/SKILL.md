...
## Next stage (automatic)

After CodeBundle is approved/advanced, pipeline enters **code_intelligence** — Agent must run `build_code_intelligence_report` (no user action required). Do not skip to handoff.
